...
With the **Pro plan**, you can use batch publishing, scheduled publishing, and delivery logging. See [Batch Publishing](/pro/batch-publishing) and [Scheduling](/pro/scheduling).
</Callout>
