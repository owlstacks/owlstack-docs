...
With the **Pro plan**, you can use batch publishing, scheduled publishing, and delivery logging. See [Batch Publishing](/guide/pro/batch-publishing) and [Scheduling](/guide/pro/scheduling).
</Callout>
