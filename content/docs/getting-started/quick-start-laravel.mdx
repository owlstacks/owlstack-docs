...
- [Laravel Configuration](/frameworks/laravel/configuration) - Full config reference
- [Laravel Usage](/frameworks/laravel/usage) - Advanced usage patterns
- [Laravel Events](/frameworks/laravel/events) - Event handling in Laravel
