...
If you prefer to manage credentials yourself, you can pass them with each publish request instead of using managed OAuth. See [Platform Credentials](/authentication/platform-credentials) for details.
