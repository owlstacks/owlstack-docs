...
The Enterprise plan is designed for large organizations that need unlimited publishing, guaranteed uptime, and dedicated support.
...
```php
// Enterprise API keys support team permissions
$client = new OwlStackClient('team-api-key');

// Keys can be scoped to specific platforms/actions
...
[Contact our sales team](https://owlstack.dev/enterprise) to discuss your requirements and get a custom quote.
